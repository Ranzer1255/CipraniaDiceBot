package net.ranzer.ciprania.dicebot.functions.draconic;
...
import net.ranzer.ciprania.dicebot.util.LogLevel;
...
public class DraconicTranslator {
	...
	private static class Dictionary {
		...
		private static final String BACKUP_FILE_LOCATION = "/diceBot/draconic/dict.txt";
