package net.ranzer.ciprania.dicebot.config;
...
public class BotConfiguration {
	...
	private static final String CONFIG_PATH = "/diceBot/config/diceBot.conf";
	...
	private String statusMessage = "with dice in the Corner";
	...
	private BotConfiguration(){
		...
		String logPath = "/diceBot/logs/diceBot.log";
	...
	@BotConfigItem(key="logLocation", type=String.class, _default="/diceBot/logs/diceBot.log")
