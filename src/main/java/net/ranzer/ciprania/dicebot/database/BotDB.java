package net.ranzer.ciprania.dicebot.database;
...
public class BotDB {
		...
		try {
			if (connection == null || connection.isClosed()){
				...
				if(!connection.prepareStatement(
						"select schema_name from information_schema.schemata where schema_name = 'cipraniadb';").
						executeQuery().next())
					initDB(connection);
			}
	...
	private static void createSchema(Connection connection) throws SQLException {
		String SQL = "CREATE SCHEMA IF NOT EXISTS cipraniadb;";
		connection.prepareStatement(SQL).execute();
	}

	private static void createTableGuild(Connection connection) throws SQLException {
		String SQL = "CREATE TABLE IF NOT EXISTS cipraniadb.guild (\n" +
	...
	private static void createTableMember(Connection connection) throws SQLException {
		String SQL = "CREATE TABLE IF NOT EXISTS cipraniadb.member\n" +
				"(\n" +
	...
	private static void createTableModeration_roles(Connection connection) throws SQLException {
		String SQL = "CREATE TABLE IF NOT EXISTS cipraniadb.moderation_roles\n" +
				"(\n" +
				"   guild_id  varchar(20)   NOT NULL,\n" +
				"   role_id   varchar(20)   NOT NULL\n" +
				");\n" +
				"\n" +
				"ALTER TABLE cipraniadb.moderation_roles\n" +
	...
	private static void createTableRaffle_Roles(Connection connection) throws SQLException {
		String SQL = "CREATE TABLE IF NOT EXISTS cipraniadb.raffle_roles\n" +
				"(\n" +
				"   guild_id  varchar(20)   NOT NULL,\n" +
				"   role_id   varchar(20)   NOT NULL\n" +
				");\n" +
				"\n" +
				"ALTER TABLE cipraniadb.raffle_roles\n" +
	...
	private static void createTableText_channel(Connection connection) throws SQLException {
		String SQL = "CREATE TABLE IF NOT EXISTS cipraniadb.text_channel\n" +
				"(\n" +
				...
				");\n" +
				"\n" +
				"ALTER TABLE cipraniadb.text_channel\n" +
	...
	private static void createTableTimedrole(Connection connection) throws SQLException {
		String SQL = "CREATE TABLE IF NOT EXISTS cipraniadb.timedrole\n" +
				"(\n" +
				"   guild_id  varchar(20)   NOT NULL,\n" +
				"   user_id   varchar(20)   NOT NULL,\n" +
				"   role_id   varchar(20)   NOT NULL,\n" +
