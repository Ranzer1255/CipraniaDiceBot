package net.ranzer.ciprania.dicebot.util;
...
public class Logging {
    ...
    public static void messageBoss(LogLevel level, String message){
    	String line = String.format("[%s\t%s] %s\n",level.name(), getTimestamp(), message);
    	PrivateChannel channel = CipraniaDiceBot.getJDA().getUserById(BotConfiguration.getInstance().getOwner()).openPrivateChannel().complete();
